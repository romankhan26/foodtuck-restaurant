...
const menuData: MenuCategory[] = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        description:
          "Grilled chicken breasts, avocado, cilantro, and lime juice",
        calories: "450 CAL",
        price: "28$",
      },
      {
    ...
    menuItems: [
      {
        ...
        description:
          "Grilled chicken breasts, bacon, lettuce, tomatoes, and onions",
        calories: "500 CAL",
        price: "25$",
      },
      {
      ...
      },
      {
        ...
        description:
          "Grilled chicken breasts, BBQ sauce, corn, and black beans",
        calories: "620 CAL",
        price: "35$",
      },
      {
